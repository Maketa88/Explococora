  ...
  return (
    <DashboardLayout>
      <div className="p-4 sm:p-6 max-w-6xl mx-auto">
        ...
        <div className="mt-8 p-4 bg-emerald-50 rounded-lg border border-emerald-100 shadow-sm">
          <div className="flex flex-col md:flex-row justify-between items-center gap-2">
            <div>
              <h3 className="text-emerald-700 font-semibold">Explococora</h3>
              <p className="text-gray-500 text-sm">Versión 1.0.0</p>
            </div>
            <div>
              <p className="text-gray-500 text-sm text-center md:text-right">© 2024 Explococora. Todos los derechos reservados.</p>
            </div>
          </div>
        </div>
      </div>
