    ...
    <div className="container mx-auto px-4 py-8">
      <div className="relative py-8 mb-10">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/2 left-12 w-4 h-4 bg-teal-700 rounded-full opacity-30 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
          <div className="absolute bottom-1/4 left-8 w-5 h-5 bg-teal-500 rounded-full opacity-25 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          
          {/* Bolitas lado derecho */}
          <div className="absolute top-1/3 right-10 w-5 h-5 bg-teal-600 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '0.7s' }}></div>
          <div className="absolute top-2/3 right-6 w-7 h-7 bg-teal-700 rounded-full opacity-15 animate-pulse" style={{ animationDelay: '1.2s' }}></div>
          <div className="absolute bottom-1/3 right-16 w-4 h-4 bg-teal-500 rounded-full opacity-25 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
