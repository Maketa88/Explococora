...
const LineasConexion = () => {
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      ...
      <div className="absolute top-1/2 left-1/4 w-2 h-2 bg-teal-500/30 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute top-1/2 left-1/2 w-2 h-2 bg-teal-500/30 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute top-1/2 left-3/4 w-2 h-2 bg-teal-500/30 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
    </div>
  );
};
...
export function PanelProcesamiento() {
  return (
    <div className="w-full bg-white rounded-xl p-6 md:p-8 shadow-lg border border-gray-100 relative overflow-hidden">
      ...
      <div className="relative z-10 mb-8 text-center">
        <h2 className="text-xl font-bold text-teal-700 inline-block relative">
          Procesando tu aventura personalizada
          <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-teal-500 to-transparent"></div>
        </h2>
      </div>
      ...
      <div className="mt-8 text-center relative z-10">
        <p className="text-teal-600 text-sm animate-pulse">
