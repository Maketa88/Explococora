    ...
    <div className="flex items-center justify-center p-10 bg-gray-200 px-4 text-center">
      <div className="max-w-4xl">
        ...
        <p className="text-base sm:text-lg lg:text-2xl leading-relaxed  text-justify font-nunito text-blue-gray-700">
          El Valle del Cocora es mucho más que un destino turístico; es un lugar
          donde la historia, la cultura y la naturaleza se entrelazan para crear
          un escenario único en el corazón de Colombia. Cada rincón de este
          valle mágico está cargado de leyendas ancestrales, tradiciones vivas y
          paisajes que quitan el aliento. Aquí, las imponentes palmas de cera
          tocan el cielo mientras susurran historias del pasado, los pueblos
          cercanos como Salento invitan a revivir las costumbres cafetaleras, y
          la biodiversidad florece como un testimonio de la riqueza de nuestra
          tierra. Prepárate para un recorrido inolvidable que despertará tus
          sentidos y te conectará con las raíces más profundas de nuestra
          historia. ¡Adéntrate en el Valle del Cocora y deja que su encanto te
          envuelva!
        </p>
      </div>
    </div>
