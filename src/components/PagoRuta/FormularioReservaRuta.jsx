...
export const FormularioReservaRuta = () => {
  ...
  const calcularTotalReserva = () => {
    ...
    const subtotalReserva =
      formData.cantidadPersonas * Number(rutaInfo?.precio || 0);

    // Total de servicios adicionales
    const subtotalServicios = serviciosAdicionales.reduce(
      (total, item) => total + parseFloat(item.servicio.precio) * item.cantidad,
      0
    );
    ...
    if (!token) {
      navigate("/Ingreso", {
        state: {
          mensaje: t(
            "debesIniciarSesion",
            "Debes iniciar sesión para reservar una ruta"
          ),
    ...
    <section className="relative py-16 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          {rutaInfo && (
            <p className="text-xl text-teal-600">{rutaInfo.nombreRuta}</p>
          )}
        </div>
              ...
              <div className="flex flex-wrap items-center justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-teal-100">
                    {rutaInfo.tipo} • {rutaInfo.dificultad}
                  </p>
                </div>

                <div className="flex flex-col items-end">
                  <div className="text-2xl font-bold">
                    ${Number(rutaInfo.precio).toLocaleString("es-CO")}{" "}
          ...
          <form onSubmit={handleSubmit} className="p-6">
              ...
              <div>
                    ...
                    onClick={() =>
                      handleChange({
                        target: {
                          name: "cantidadPersonas",
                          value: Math.min(
                            parseInt(rutaInfo?.capacidadMaxima || 99),
                ...
                {rutaInfo && (
                  <p className="mt-1 text-xs text-gray-500">
                    ...
                    {rutaInfo.capacidadMaxima} {t("personas", "personas")}
                  </p>
                )}
              </div>
                    ...
                    <div className="pb-5">
                      <div className="flex items-center mb-4">
                        ...
                        <h4 className="text-lg font-semibold text-gray-800">
                          {t("detallesRuta", "Detalles de la ruta")}
                        </h4>
                      </div>
                      ...
                      <div className="py-5">
                        ...
                        <div className="space-y-2 pl-11">
                          {serviciosAdicionales.map((item, index) => (
                            <div
                              key={index}
                              className="flex justify-between items-center py-1.5 border-b border-dashed border-teal-50 last:border-0"
                            >
                              <div className="flex items-center text-gray-700">
                                <svg
                      ...
                      <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-lg p-4 shadow-sm">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="bg-white text-teal-800 font-bold text-xl px-4 py-1.5 rounded-lg shadow-sm">
                            ${calcularTotalReserva().toLocaleString("es-CO")}{" "}
                            COP
                          </div>
                        </div>
                      </div>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-end">
              ...
              <button
                type="submit"
                disabled={
                  cargando || !formData.fechaInicio || !formData.fechaFin
                }
