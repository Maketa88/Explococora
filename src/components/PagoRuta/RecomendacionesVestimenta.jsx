    ...
    if (!aceptaRecomendaciones) {
      setError(
        t(
          ...
          "Debes aceptar las recomendaciones para continuar"
        )
      );
      return;
    }
            ...
            <div className="border border-t-0 border-teal-200 rounded-b-lg p-4 bg-white">
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Botas de senderismo con suela antideslizante, resistentes al
                    agua y con buen soporte para el tobillo para evitar
                    resbalones en terrenos húmedos.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal-600 font-bold min-w-[80px]">
                  ...
                  <p>
                    Gorra o sombrero para protegerse del sol, gafas de sol,
                    guantes térmicos para el frío y bufanda para proteger el
                    cuello.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Chaqueta impermeable o poncho para mantenerse seco en caso
                    de llovizna.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Bloqueador solar, repelente de insectos y una mochila
                    pequeña con agua, snacks energéticos y una muda de ropa seca
                    en caso de mojarse.
                  </p>
                </li>
              </ul>
            ...
            <div className="border border-t-0 border-teal-200 rounded-b-lg p-4 bg-white">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Pantalones largos y cómodos para evitar roces y proteger las
                    piernas del frío y la vegetación.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal-600 font-bold min-w-[80px]">
                  ...
                  <p>
                    Botas resistentes al agua o zapatos cerrados con suela
                    antideslizante para mayor estabilidad en terrenos húmedos.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal-600 font-bold min-w-[80px]">
                  ...
                  <p>
                    Sombrero o gorra para el sol, gafas de sol y guantes
                    térmicos para mejorar el agarre de las riendas y proteger
                    las manos del frío.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Chaqueta impermeable y cortaviento en caso de lluvia o
                    temperaturas bajas.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Protector solar, repelente de insectos y una botella de agua
          ...
          <div className="mb-8">
            ...
            <div className="border border-t-0 border-teal-200 rounded-b-lg p-4 bg-white">
              <ul className="space-y-4 list-disc list-inside pl-4 text-gray-700">
                <li>
                  Dado que el clima en el Valle del Cocora es frío y con lluvias
                  ocasionales, es recomendable llevar siempre ropa de abrigo e
                  impermeable.
                </li>
                <li>
                  Se recomienda evitar ropa de algodón, ya que retiene la
                  humedad y puede causar incomodidad en climas fríos y húmedos.
                </li>
                <li>
                  Llevar una muda de ropa seca en caso de que la lluvia o la
                  humedad afecten la vestimenta.
                </li>
                <li>
                  Seguir siempre las indicaciones de los guías y organizadores
                  para garantizar una experiencia segura y agradable.
                </li>
              </ul>
            </div>
          </div>
