...
export const BotonPagoRuta = ({ ruta, className }) => {
  ...
  const estaHabilitado = ruta?.estado === 'Activa' && ruta?.precio > 0;
    ...
    if (!token) {
      ...
      navigate('/Ingreso', { 
        state: { 
          ...
          redireccion: `/NuestrasRutas/${ruta.idRuta}`
        } 
      });
      return;
    }
