...
import { 
  FaSearch, FaMinus, FaPlus, 
  FaAngleDown, FaAngleUp, FaPlusCircle,
  FaTshirt, FaUtensils, FaBed, FaHiking,
  FaGift, FaWineBottle, FaQuestion,
  FaUmbrella, FaHatCowboy, FaShoppingBag,
  FaCampground, FaWater, FaFish, FaCoffee,
  FaHamburger, FaCookie, FaPizzaSlice, FaCheese,
  FaSun, FaLeaf, FaTint, FaHome, FaHotel,
  FaWineGlassAlt, FaBug, FaSocks, 
  FaGlassMartini, FaGlassMartiniAlt,
  FaShoppingBasket, FaDrumstickBite, FaConciergeBell, 
  FaRunning, FaPaintBrush, FaGlassCheers, FaEllipsisH
} from 'react-icons/fa';

// Mapeo de categorías a iconos con iconos mejorados 
const CATEGORY_ICONS = {
  'Indumentaria': <div className="flex items-center justify-center bg-blue-100 rounded-full p-1.5">
                    <FaTshirt className="text-blue-600 text-lg" />
                  </div>,
  'Alimentación': <div className="flex items-center justify-center bg-orange-100 rounded-full p-1.5">
                    <FaDrumstickBite className="text-orange-600 text-lg" />
                  </div>,
  'Alojamiento': <div className="flex items-center justify-center bg-purple-100 rounded-full p-1.5">
                   <FaConciergeBell className="text-purple-600 text-lg" />
                 </div>,
  'Actividades': <div className="flex items-center justify-center bg-green-100 rounded-full p-1.5">
                   <FaRunning className="text-green-600 text-lg" />
                 </div>,
  'Artesanías': <div className="flex items-center justify-center bg-red-100 rounded-full p-1.5">
                  <FaPaintBrush className="text-red-600 text-lg" />
                </div>,
  'Bebidas': <div className="flex items-center justify-center bg-teal-100 rounded-full p-1.5">
               <FaGlassCheers className="text-teal-600 text-lg" />
             </div>,
  'Otros': <div className="flex items-center justify-center bg-gray-100 rounded-full p-1.5">
             <FaEllipsisH className="text-gray-600 text-lg" />
           </div>,
  'Todos': <div className="flex items-center justify-center bg-teal-100 rounded-full p-1.5">
...
const SERVICE_ICONS = {
  ...
  // Otros
  'Bloqueador solar': <div className="h-7 w-7 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-yellow-500">
                          ...
                          <path fillRule="evenodd" d="M7 9C5.89543 9 5 9.89543 5 11V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V11C19 9.89543 18.1046 9 17 9H7ZM9.5 12C9.22386 12 9 12.2239 9 12.5V13.5C9 13.7761 9.22386 14 9.5 14H14.5C14.7761 14 15 13.7761 15 13.5V12.5C15 12.2239 14.7761 12 14.5 12H9.5Z" clipRule="evenodd" />
                        </svg>
                      </div>,
  'Repelente': <div className="h-7 w-7 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-red-600">
                  {/* Cuerpo del mosquito */}
                  <path d="M12,18 C9,18 6.5,16 6.5,13.5 C6.5,11 8,10 8,8 C8,6 10,4 12,4 C14,4 16,6 16,8 C16,10 17.5,11 17.5,13.5 C17.5,16 15,18 12,18Z" strokeLinecap="round" fill="rgba(183, 28, 28, 0.2)"/>
  ...
  'Protector solar': <div className="h-7 w-7 flex items-center justify-center">
                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="text-orange-400">
                         <path d="M8 7C8 5.93913 8.42143 4.92172 9.17157 4.17157C9.92172 3.42143 10.9391 3 12 3C13.0609 3 14.0783 3.42143 14.8284 4.17157C15.5786 4.92172 16 5.93913 16 7V10H8V7Z" />
                         <path fillRule="evenodd" d="M7 9C5.89543 9 5 9.89543 5 11V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V11C19 9.89543 18.1046 9 17 9H7ZM9.5 12C9.22386 12 9 12.2239 9 12.5V13.5C9 13.7761 9.22386 14 9.5 14H14.5C14.7761 14 15 13.7761 15 13.5V12.5C15 12.2239 14.7761 12 14.5 12H9.5Z" clipRule="evenodd" />
                       </svg>
                     </div>,
  'Repelente contra insectos': <div className="h-7 w-7 flex items-center justify-center">
                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-red-600">
                                   {/* Cuerpo del mosquito */}
                                   <path d="M12,18 C9,18 6.5,16 6.5,13.5 C6.5,11 8,10 8,8 C8,6 10,4 12,4 C14,4 16,6 16,8 C16,10 17.5,11 17.5,13.5 C17.5,16 15,18 12,18Z" strokeLinecap="round" fill="rgba(183, 28, 28, 0.2)"/>
                                   ...
                                   <circle cx="12" cy="12" r="9" stroke="red" strokeWidth="1" fill="none" opacity="0.3"/>
...
const getIconForService = (servicio) => {
  ...
  if (nombreLower.includes('bloqueador') || nombreLower.includes('protector solar')) 
  ...
  return CATEGORY_ICONS[servicio.categoria] || <FaQuestion className="text-gray-600 text-xl" />;
};

export const ServiciosAdicionalesPaquete = ({ onServiciosChange, cantidadPersonas = 1 }) => {
  ...
  useEffect(() => {
    const obtenerDatos = async () => {
      ...
      try {
        ...
        // Obtener categorías
        const resCategorias = await axios.get('http://localhost:10101/servicios-adicionales/categorias');
        ...
        const resServicios = await axios.get('http://localhost:10101/servicios-adicionales');
        ...
        setError(t('errorCargandoServicios', 'No se pudieron cargar los servicios adicionales'));
      } finally {
        setCargando(false);
      }
    };
  ...
  useEffect(() => {
    if (onServiciosChange) {
      ...
      const serviciosArray = Object.entries(serviciosSeleccionados).map(([idServicio, cantidad]) => {
        const servicio = servicios.find(s => s.idServicio === parseInt(idServicio));
      ...
      console.log("Enviando servicios al componente padre:", serviciosArray);
  ...
  const serviciosFiltrados = useMemo(() => {
    return servicios.filter(servicio => {
      ...
      if (busqueda) {
        ...
        return servicio.nombre.toLowerCase().includes(terminoBusqueda) ||
               servicio.descripcion.toLowerCase().includes(terminoBusqueda);
      }
      
      // Si no hay búsqueda, aplicar filtro por categoría
      return categoriaActiva === 'Todos' || servicio.categoria === categoriaActiva;
    });
  ...
  const calcularTotal = () => {
    return Object.entries(serviciosSeleccionados).reduce((total, [idServicio, cantidad]) => {
      const servicio = servicios.find(s => s.idServicio === parseInt(idServicio));
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                {t('descripcionServiciosAdicionales', '¿Desea agregar servicios adicionales a su experiencia?')}
              </p>
            </div>
            <button
              type="button"
  ...
  return (
    <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-teal-700 mb-2">
              {t('serviciosAdicionales', 'Servicios adicionales')} <span className="text-sm font-normal text-gray-500">({t('opcionales', 'Opcionales')})</span>
            </h2>
            <p className="text-gray-600 text-sm">{t('descripcionServiciosAdicionales', 'Mejora tu experiencia con estos servicios adicionales.')}</p>
          </div>
          <button
            type="button"
      ...
      <div className="p-5 bg-teal-50 rounded-lg mb-4">
        ...
        <div className="relative mb-5 max-w-xl mx-auto">
          ...
          <input
            ...
            placeholder={t('ejemplosServicios', 'Repelente, camping, poncho, almuerzo...')}
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-3">
          {categorias.map((categoria, index) => (
            ...
            >
              <span className="mr-2">
                {CATEGORY_ICONS[categoria] || <FaQuestion className="text-gray-400" />}
              </span>
      ...
      {busqueda && categoriaActiva !== 'Todos' && serviciosFiltrados.some(s => s.categoria !== categoriaActiva) && (
        <div className="bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-3 mb-4 rounded-r-lg">
          <div className="flex items-center">
            ...
            <span>
              {t('resultadosBusquedaTodasCategorias', 'Mostrando resultados de todas las categorías para')}: 
      ...
      <div className="p-4">
        {cargando ? (
          <div className="p-4 text-center">
            ...
            <p className="text-teal-600">{t('cargandoServicios', 'Cargando servicios adicionales...')}</p>
          </div>
        ) : error ? (
          ...
          <div className="space-y-4">
            {Object.entries(serviciosPorCategoria).map(([categoria, serviciosCategoria]) => (
              <div key={categoria} className="bg-white rounded-lg overflow-hidden shadow border border-gray-100">
                <div className="bg-teal-600 text-white px-4 py-2 flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="mr-2 text-teal-200">
                      {CATEGORY_ICONS[categoria] || <FaQuestion className="text-teal-600" />}
                    </div>
                ...
                <div className="divide-y divide-gray-100">
                  ...
                  {(categoriaActiva === 'Todos' 
                    ? serviciosCategoria.slice(0, categoriasExpandidas[categoria] ? undefined : 2) 
                    : serviciosCategoria
                  ).map(servicio => (
                    <div
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        {serviciosSeleccionados[servicio.idServicio] ? (
                          <>
                            <button 
                              ...
                              onClick={() => cambiarCantidad(
                                servicio.idServicio, 
                                serviciosSeleccionados[servicio.idServicio] - 1
                              )}
                          ...
                          <button 
                            type="button"
                            onClick={() => cambiarCantidad(servicio.idServicio, 1)}
                  ...
                  {categoriaActiva === 'Todos' && serviciosCategoria.length > 2 && (
                    <button
                      type="button"
                      onClick={() => {
                        setCategoriasExpandidas(prev => ({
                    ...
                    >
                      {categoriasExpandidas[categoria] ? (
                        ...
                        <>
                          <span>
                            {t('verMas', 'Ver')} {serviciosCategoria.length - 2} {t('mas', 'más')}
                          </span>
          ...
          <div className="p-8 text-center text-gray-500">
            {t('noHayServiciosDisponibles', 'No hay servicios disponibles que coincidan con tu búsqueda.')}
          </div>
        )}
      </div>
      ...
      {Object.keys(serviciosSeleccionados).length > 0 && (
        <div className="p-4 border-t border-gray-200 bg-teal-50">
          <h3 className="font-medium text-teal-800 mb-2">{t('resumenServicios', 'Servicios seleccionados')}</h3>
          
          <div className="space-y-2 mb-3">
            {Object.entries(serviciosSeleccionados).map(([idServicio, cantidad]) => {
              const servicio = servicios.find(s => s.idServicio === parseInt(idServicio));
              if (!servicio || cantidad <= 0) return null;
