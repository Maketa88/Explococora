...
export const AutorizacionMenoresPaquetes = () => {
  ...
  const handleCancelar = () => {
    navigate(`/VistaCliente/reserva-paquete/${idPaquete}`, {
      state: { paqueteInfo },
    });
  };
  ...
  return (
    <section className="relative py-10 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {paqueteInfo && (
          <div className="bg-gradient-to-r from-teal-700 to-teal-600 text-white p-6 rounded-t-xl shadow-lg transform hover:scale-[1.01] transition-transform duration-300 justify-between">
        ...
        <div className="relative bg-white rounded-b-xl shadow-lg p-8 border-t-4 border-teal-500">
          ...
          <div className="flex items-center justify-center gap-3 mb-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-teal-800">
              Autorización y Cumplimiento de Políticas de Seguridad para Menores
              de Edad
            </h2>
          </div>
          ...
          <div className="text-gray-700 space-y-6 mb-8 px-4 py-6 bg-gradient-to-br from-teal-50 to-white rounded-xl border border-teal-100 shadow-sm text-justify">
            <p className="leading-relaxed">
              <span className="text-teal-700 font-semibold">
                Como padre, madre o representante legal
              </span>
              , autorizo la participación de mi hijo/a o menor a cargo en la
              actividad de cabalgata o caminata organizada en el Valle del
              Cocora, Salento, Quindío, a través de la Pagina Web Explococora
              Declaro que he sido informado/a sobre los riesgos inherentes a
              esta actividad y acepto las normas de seguridad establecidas,
              incluyendo las restricciones de edad aplicables a menores entre 12
              y 18 años, según la Norma Técnica Sectorial AV 014.
            </p>

            <div className="flex items-start gap-2">
              <p className="leading-relaxed">
                Entiendo que la cabalgata o caminata puede implicar ciertos
                riesgos naturales, como terrenos irregulares, cambios climáticos
                inesperados y la interacción con caballos u otros animales
                presentes en la zona. La operadora turística ha explicado de
                manera clara y suficiente las medidas de seguridad
                implementadas, incluyendo su plan de prevención, atención y
            ...
            <div className="flex items-start gap-2">
              <p className="leading-relaxed">
                Declaro que el menor se encuentra en condiciones óptimas de
                salud y no presenta contraindicaciones médicas para participar
                en la actividad. Asimismo, comprendo y acepto las normas
                reguladoras de la cabalgata o caminata, y asumo la total
                responsabilidad por cualquier eventualidad que pueda ocurrirle
                al menor durante el recorrido, exceptuando aquellas derivadas de
                negligencia por parte de la organización.
              </p>
            </div>

            <div className="flex items-start gap-2">
              <p className="leading-relaxed">
                Confirmo que la operadora turística no proporciona alimentos y
                no se hace responsable por los alimentos consumidos durante la
                actividad.
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              <p className="leading-relaxed">
                La actividad cuenta con cobertura de seguro de accidentes
                personales a través de la Compañía Suramericana de Seguros, bajo
                las pólizas N° 0844000581780 y 90000647859.
              </p>
            </div>

            <div className="flex items-start gap-2">
              <p className="leading-relaxed">
                Autorizo el uso de imágenes capturadas durante la cabalgata o
                caminata para su posible publicación en la página web, redes
                sociales o boletín informativo de Explococora.
              </p>
            </div>

            <div className="flex items-start gap-2">
              <p className="leading-relaxed">
                Al marcar esta casilla, autorizo la participación del menor en
                el recorrido y confirmo que acepto todas las condiciones y
                términos aquí establecidos. Asumo la total responsabilidad sobre
                la participación del menor, sin necesidad de presentar una firma
                física o documento adicional.
              </p>
            </div>
          </div>
              ...
              >
                <svg
                  className={`fill-current w-3 h-3 text-teal-600 pointer-events-none ${
                    aceptaTerminos ? "opacity-100" : "opacity-0"
                  }`}
                  viewBox="0 0 20 20"
                >
