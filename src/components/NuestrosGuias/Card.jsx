...
const CardGuia = ({ guia }) => {
  ...
  return (
    <div className="relative w-full h-auto min-h-[600px] rounded-xl overflow-hidden shadow-2xl bg-white">
      ...
      >
        ...
        <div className="w-full h-full flex items-center justify-center overflow-hidden">
          <img 
            ...
            alt={`Foto de ${nombres}`} 
            className={`max-w-full max-h-full object-contain transition-transform duration-700 group-hover:scale-110 ${!imagenCargada ? 'opacity-0' : 'opacity-100'}`}
      ...
      {/* Contenido - Ahora con altura automática */}
      <div className="p-6 z-20 bg-white relative shadow-[0_-10px_30px_-15px_rgba(0,0,0,0.1)]">
        {/* Información del guía */}
        <div className="text-gray-800">
          <div className="flex items-center mb-3">
            {/* Icono para el nombre - Persona/Guía */}
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-500 mr-3 shadow-lg">
          ...
          {apellidos && (
            <div className="flex items-center mb-4">
              ...
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-purple-500 mr-3 shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="space-y-4 mt-5">
            <div className="flex items-start text-sm">
              ...
              <div className="flex items-center justify-center w-8 h-8 rounded-full bg-amber-500 mr-3 shadow-md shrink-0">
            ...
            {guia.email && (
              <div className="flex items-start text-sm">
                {/* Icono para el email */}
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-green-500 mr-3 shadow-md shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex flex-col max-w-[calc(100%-44px)]">
                  ...
                  <span className="truncate text-gray-700 font-medium break-words">{guia.email}</span>
                </div>
              </div>
            )}
            ...
            {guia.telefono && (
              <div className="flex items-start text-sm">
                ...
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-500 mr-3 shadow-md shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex flex-col max-w-[calc(100%-44px)]">
                  ...
                  <span className="truncate text-gray-700 font-medium">{guia.telefono}</span>
                </div>
              </div>
            )}
          </div>
                ...
                {[...Array(5)].map((_, index) => (
                  ...
                  >
                    <svg 
                      ...
                      className="h-10 w-10 mx-0.5 drop-shadow-lg" 
                      viewBox="0 0 20 20" 
                      fill="#FFD700"
                    >
