...
const mapearCamposGuia = (datosGuia) => {
  ...
  if (datosGuia.nombre_del_guia) {
    ...
    if (partesNombre.length >= 3) primerApellido = partesNombre.slice(2).join(' ');
  }
  ...
  return (
    ...
    <div className="relative py-12 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        {error && (
          <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-6 rounded-lg shadow-md my-8 max-w-2xl mx-auto" role="alert">
        ...
        {!loading && !error && guias.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            {/* Mostrar solo los primeros 3 guías en la página de inicio */}
