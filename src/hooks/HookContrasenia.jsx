    ...
    <div className="mb-6">
      ...
      <div className="relative">
        <span className="absolute inset-y-0 left-0 flex items-center pl-3">
          <FaLock className="h-5 w-5 text-emerald-400" />
        </span>
        <input
          ...
          placeholder="********"
          className="w-full pl-10 pr-10 px-4 py-2 border border-emerald-200 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
          required
        />
        <span
